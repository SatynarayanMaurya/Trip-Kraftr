...
const AddRegion = lazy(() => import("../components/Regions/AddRegion"));
const ViewRegion = lazy(() => import("../components/Regions/ViewRegion"));
const EditRegion = lazy(() => import("../components/Regions/EditRegion"));
