...
// // ===== components/Pdf/PdfCoverSection.jsx =====
// import React from "react";
...
//       />
//       {/* Overlay-style caption block sits below hero since real overlay text needs the image to load reliably in PDF export */}
//       <div className="mt-3 mb-1">
//         <div className="text-xs font-semibold tracking-wide" style={{ color: PINK }}>
//           {tripLabel} | {days} DAYS
//         </div>
...
//           Starting from <span className="font-semibold" style={{ color: PINK }}>{startingPrice}</span> / per person
//         </div>
//       </div>
