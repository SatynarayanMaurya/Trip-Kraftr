...
function AddEnquiryB2C({ onCancel }) {
    ...
    const handleSelectAccount = (acc) => {
        ...
        setSearchInput(acc.fullName ?? '');
        setForm((prev) => ({
            ...prev,
            totalMembers: acc?.noOfMembers || 1,
        }));
        setShowSuggestions(false);
        setSearchedAccounts([]);
    };
        ...
        <div style={{ fontFamily: "'Segoe UI', sans-serif" }}>
            ...
            <div style={{
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '18px 24px' }}
                    ...
                    <div style={{ ...fieldWrap, position: 'relative' }} ref={searchRef}>
                        ...
                        <div style={{ position: 'relative' }}>
                            ...
                            {fetchLoading
                                ...
                                : searchInput
                                    ? <FiX style={{ ...searchIcon, color: "red", cursor: 'pointer' }} onClick={handleClearAccount} />
                    ...
                    <div style={fieldWrap}>
                        <label style={cardLabelStyle}>
                            <FiUsers style={{ color: PINK, marginRight: 5, verticalAlign: 'middle' }} />
                            Total Members
                        </label>
                        <input
                            type="text"
                            value={selectedAccount?.noOfMembers != null
                                ? String(selectedAccount.noOfMembers).padStart(2, '0')
                                : ''}
                            disabled
                            placeholder="Auto filled"
                            style={cardValueStyle}
...
//           {/* Full Name (search) */}
//           <div style={{ ...fieldWrap, position: 'relative' }} ref={searchRef}>
//             <label style={{ ...labelStyle, color: PINK }}>
...
//                 ? <span style={spinnerStyle} />
//                 : searchInput
//                   ? <FiX style={{ ...searchIcon, cursor: 'pointer' }} onClick={handleClearAccount} />
...
//           <div style={fieldWrap}>
//             <label style={{ ...labelStyle, color: PINK }}>
//               <FiMail style={{ marginRight: 5, verticalAlign: 'middle' }} />
//               Email Id *
//             </label>
//             <input
//               type="text"
...
//           <div style={fieldWrap}>
//             <label style={{ ...labelStyle, color: PINK }}>
//               <FiPhone style={{ marginRight: 5, verticalAlign: 'middle' }} />
//               Phone no. *
//             </label>
//             <input
//               type="text"
...
//           <div style={fieldWrap}>
//             <label style={{ ...labelStyle, color: PINK }}>
//               <MdOutlineTravelExplore style={{ marginRight: 5, verticalAlign: 'middle' }} />
//               Source *
//             </label>
//             <input
//               type="text"
...
//           <div style={fieldWrap}>
//             <label style={{ ...labelStyle, color: PINK }}>
//               <FiUsers style={{ marginRight: 5, verticalAlign: 'middle' }} />
//               Total Members
//             </label>
//             <input
//               type="text"
