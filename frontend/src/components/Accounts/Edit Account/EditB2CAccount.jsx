...
function EditB2CAccount() {

  const {getB2CAccountById,updateB2CAccountById} = useAccountHooks()
...
//   console.log("account details : ",accountDetails)
  ...
  useEffect(() => {
    if (accountDetails) {
      setForm({
        ...
        destinations: accountDetails.destinations || [],
        noOfMembers: accountDetails.noOfMembers || '',
  ...
  const handleSubmit = async() => {
    ...
    try{
        ...
        const response = await updateB2CAccountById(payload)
