...
export const XIcon = ({ size = 4 }) => (
  <svg className={`h-${size} w-${size}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const StarIcon = ({ filled }) => (
  <svg className={`h-3.5 w-3.5 ${filled ? 'text-yellow-400' : 'text-slate-600'}`} fill={filled ? 'currentColor' : 'none'} viewBox="0 0 24 24" stroke="currentColor">
