...
import VehicleSectionPrivateTrip from './VehicleSectionPrivateTrip';
...
function ItineraryBuilderPrivateTrip({
    ...
    price, setPrice, fetchRoomRateAgain
}) {
...
export default ItineraryBuilderPrivateTrip
