...
export const privateTripEndpoints  = {
    ...
    SEARCH_PRIVATE_TRIPS : BASE_URL + '/search-private-trip',
    UPDATE_PRIVATE_TRIP_STATUS: BASE_URL + '/update-private-trip-status',
    ...
    DELETE_PRIVATE_TRIP_BY_ID : BASE_URL + '/delete-private-trip-by-id',
}
